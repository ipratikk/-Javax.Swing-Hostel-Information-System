...
1. a) **ALL – for displaying all student records**
2. b)**Specific Name – for displaying student(s) record with the entered name**
3. c) **ID – for displaying student record based on ID which is unique**
...
**       Fig 5.2: Search result for Hostel Information              Fig 5.3: Search result for students in a hostel**
